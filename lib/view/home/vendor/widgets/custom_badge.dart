...
class RPSCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Since your original points go up to ~18.66, we scale based on that.
    double scaleX = size.width / 20.0;
    double scaleY = size.height / 20.0;

    // Scale the canvas so your small coordinates fill the big space
    ...
    Paint strokePaint = Paint()
      ...
      ..strokeWidth =
          1.0 // Fixed at 1.0 because it's being scaled up
      ..color = Colors.blue
    ...
    Paint checkPaint = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth =
          1.5 // Fixed small value that scales up
      ..color = Colors.white
      ..strokeCap = StrokeCap.round
      ..strokeJoin = StrokeJoin.round;
